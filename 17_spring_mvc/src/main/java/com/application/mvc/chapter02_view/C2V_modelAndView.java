...
public class C2V_modelAndView {
	...
	@Autowired
	private SupposeDAO supposeDAO;// dat연결
	 ...
	 * 1) HttpServeletmodel
	 * 
	 * - 컨트롤러 클래스 메서드의 파라메타로 HttpServletmodel를 추가하여 사용한다.
	...
	@GetMapping("/model")
	public String model(Model model) {//import org.springframework.ui.Model; 을 import한다.
	...
	public ModelAndView modelAndView() { // return타입은 String이 아닌 ModelAndView클래스를 작성한다.
		...
		ModelAndView mv = new ModelAndView("chapter02_view/c2v");// 생성자의 파라메타에 view경로를 작성한다.
