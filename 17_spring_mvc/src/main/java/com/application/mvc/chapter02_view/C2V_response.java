...
public class C2V_response {
	 ...
	 * 	- 한글 데이터가 전송이 되지 않아서 한글 데이터 전송시 ReponseEntity에 헤더를 추가하여 사용한다.-> 전송이된다?
     *
	 */
	...
	@GetMapping("/responseEintity")
	public ResponseEntity<Object> responseEintity() {
