...
public class V2C_binding {
	...
	public String modelAttribute( ProductDTO productDTO,
		...
		System.out.println();
		//ProductDTO(productId=123, productNm=아무말, price=1234, deliveryPrice=1, enrollDt=Thu Feb 08 00:00:00 KST 2024, brandId=1)


		
		return "redirect:/v2c";// 에러발생 : 경로오류 404(not found) 발생 확인
	}
	...
	public String map(@RequestParam Map<String, Object> productMap) {
		...
		System.out.println();
		//@RequestParam Map 
//      {isPC=true, locationId=1, lang=kor, productId=123, productNm=ㅁ, price=1234, deliveryPrice=1, enrollDt=2024-02-08, brandId=1}
